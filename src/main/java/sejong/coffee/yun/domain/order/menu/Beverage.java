...
public class Beverage extends Menu {
    ...
    @Builder
    public Beverage(Long id, String title, String description, Money price, Nutrients nutrients, MenuSize menuSize, LocalDateTime now, int quantity, int orderCount) {
